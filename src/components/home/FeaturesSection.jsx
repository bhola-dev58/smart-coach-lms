const features = [
  {
    ...
    desc: 'Learn from 35+ expert educators from top institutions with 10+ years of teaching experience.',
  },
  {
  ...
  },
  {
    ...
    desc: 'In-depth coverage of school curriculum (CBSE/ICSE) and foundational preparation for JEE, NEET, and Olympiads.',
  },
  {
    ...
    <section className="section section-white">
      <div className="container">
        <div className="section-header">
          ...
          <h2>Built for Class 8th to 12th Students</h2>
          <div className="section-divider" />
          <p>We combine academic rigor with conceptual clarity to ensure you excel in school, board exams, and competitive targets.</p>
        </div>
