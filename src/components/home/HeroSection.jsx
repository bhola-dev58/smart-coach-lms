    ...
    <section className={styles.hero}>
      ...
      <div className={`container ${styles.heroContent}`}>
        ...
        <div className={styles.heroTrust}>
          <div className={styles.trustItem}><strong>10,000+</strong><span>Active Students</span></div>
          <div className={styles.trustDivider} />
          <div className={styles.trustItem}><strong>50+</strong><span>Expert Courses</span></div>
          <div className={styles.trustDivider} />
          <div className={styles.trustItem}><strong>95%</strong><span>Placement Rate</span></div>
        </div>
      </div>
    </section>
  );
