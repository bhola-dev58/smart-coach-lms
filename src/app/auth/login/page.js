...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (res?.error) {
      ...
      } else if (res.error === 'Please login using your social account') {
        setError('This email is linked to Google. Please use "Sign in with Google".');
      } else {
    ...
    <div className={styles.authContainer}>
      <div className={styles.authCard}>
        ...
        <button
          ...
          style={{ background: 'white', color: '#333', border: '1px solid #ccc', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '0.5rem', marginBottom: '1rem' }}
